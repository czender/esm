...
readonly CASE_NAME="v3.LR.piControl.I.hex_eqm"
...
readonly CUSTOM_WALLTIME="30:00:00"
...
cat << EOF >> user_nl_elm
 ...
 hist_fincl1 = 'SNOWDP','COL_FIRE_CLOSS','NPOOL','PPOOL','TOTPRODC','SNORDSL','FSR','FIRE','FIRA','QSNWCPLIQ'
