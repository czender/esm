...
readonly CASE_NAME="v3.LR.piControl-shallowfirn"
...
cat << EOF >> user_nl_elm
 ...
 hist_fincl1 = 'SNOWDP','COL_FIRE_CLOSS','NPOOL','PPOOL','TOTPRODC','SNORDSL','FSR','FIRE','FIRA'
...
! finidat = '/lcrc/group/acme/ac.dcomeau/scratch/chrys/finidat_files/20241113.WCYCL1850.ne30pg2_r05_IcoswISC30E3r5.pm-cpu.gnu.v3.LR.piControl.interp_dfsp_revbgc.1001-01-01.nc'
